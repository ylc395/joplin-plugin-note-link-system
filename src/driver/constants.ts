...
export const EXTRA_SYNTAX_ENABLED_SETTING = 'EXTRA_SYNTAX_ENABLED_SETTING';
export const URL_ICON_ENABLED_SETTING = 'URL_ICON_ENABLED_SETTING';
export const PREVIEWER_URL_BLACKLIST_SETTING = 'PREVIEWER_URL_BLACKLIST_SETTING';
export const PREVIEWER_URL_BLACKLIST_LOCAL = 'joplin';
export const URL_FOLD_ICON_SETTING = 'URL_FOLD_ICON_SETTING';
